 ...
 */
final class Version20250419161911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attachment (id INT AUTO_INCREMENT NOT NULL, original_name VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, issue_id INT NOT NULL, INDEX IDX_795FD9BB5E7AA58C (issue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE issue (id INT AUTO_INCREMENT NOT NULL, type SMALLINT NOT NULL, summary VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, story_point_estimate INT DEFAULT NULL, status SMALLINT NOT NULL, project_id INT NOT NULL, assignee_id INT DEFAULT NULL, reporter_id INT NOT NULL, INDEX IDX_12AD233E166D1F9C (project_id), INDEX IDX_12AD233E59EC7D60 (assignee_id), INDEX IDX_12AD233EE1CFE6F5 (reporter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, key_code VARCHAR(5) NOT NULL, lead_user_id INT NOT NULL, INDEX IDX_2FB3D0EEFEA08FFB (lead_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
